          ...
          <Card title="Datos de la Solicitud de Crédito" icon={<FilePlus2 size={18} />}>
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="hb-field" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 10 }}>
                ...
                <label htmlFor="seguro" style={{ margin: 0, cursor: 'pointer' }}>Incluye Seguro de Desgravamen (TEA 12.99%)</label>
              </div>
              {!form.con_seguro && <p style={{ fontSize: '0.8rem', color: 'var(--hb-text-muted)', marginTop: -6, marginLeft: 28 }}>Sin seguro, la TEA será de 17.99%</p>}
